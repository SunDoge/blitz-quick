...
(function () {
    ...
    function normalizeIncomingArray(normalized, array, unwrap) {
      ...
      for (let i = 0, len = array.length; i < len; i++) {
        ...
        if (item2 == null || item2 === true || item2 === false);
          ...
          normalized.push(createTextNode2(item2));
        } else if (t === "function") {
          if (unwrap) {
  ...
  var structuredClone$1 = { exports: {} };
  var clone$2 = {};
  function clone$1(oToBeCloned, cloned, clonedpairs) {
    cloned = cloned || [];
      ...
      default:
        if (Buffer.isBuffer(oToBeCloned)) {
          ...
          for (var sProp in oToBeCloned) {
            oClone[sProp] = clone$1(oToBeCloned[sProp], cloned, clonedpairs);
          }
        }
    }
    return oClone;
  ...
  function derez(value, path2, objects, paths, buffers) {
    if (Buffer.isBuffer(value)) {
      ...
      buffers.push(value);
      return "b" + [start, value.length].join(",");
    }
    if (value instanceof Date) {
      return "d" + value.toJSON();
    }
    if (value instanceof RegExp) {
      return "r" + encodeRegExp(value);
    }
    if (value instanceof Error) {
      return "e" + value.message;
    }
    if (typeof value == "string") {
      return value.charAt(0) == "" ? "s" + value : value;
    }
    var i, name, nu;
    if (
      typeof value === "object" &&
  ...
  serialize.serialize = function (object) {
    var objects = [],
      paths = [],
      buffers = [];
  ...
  serialize.deserialize = function (buf) {
  ...
  structuredClone$1.exports = clone$2.clone;
  var clone = (structuredClone$1.exports.clone = clone$2.clone);
  structuredClone$1.exports.serialize = serialize.serialize;
  structuredClone$1.exports.deserialize = serialize.deserialize;
  if (
  ...
  function normalizePath(path2, omitSlash = false) {
    const s = path2.replace(trimPathRegex, "$1");
  ...
  function createMatcher(path2, partial, matchFilters) {
    ...
    const route = {
      ...
      outlet: () =>
        component
          ...
          : outlet(),
      resolvePath(to) {
        return resolvePath(base.path(), to, path2());
      },
    };
    return route;
  }
  ...
  function AppShell(props) {
    ...
    return (() => {
      ...
      setProp(
        _el$,
        "class",
        "w-full h-screen overflow-hidden flex bg-[#eef0f2] text-[#20272e] font-sans select-none",
      );
      ...
      setProp(
        _el$2,
        "class",
        "w-48 flex-none flex flex-col bg-[#20262d] text-[#d8dde2] border-r border-[#151a1f]",
      );
      ...
      setProp(
        _el$3,
        "class",
        "h-16 px-5 flex items-center gap-3 border-0 border-b border-[#303840] bg-transparent text-white text-left cursor-pointer",
      );
      ...
      setProp(
        _el$4,
        "class",
        "w-7 h-7 flex items-center justify-center bg-[#f26522] text-white font-serif text-base",
      );
      ...
      setProp(
        _el$12,
        "class",
        "w-full h-9 px-3 flex items-center gap-3 border-0 rounded bg-transparent text-[#9da8b2] text-xs text-left cursor-pointer disabled:opacity-55",
      );
      ...
      setProp(
        _el$14,
        "class",
        "mt-2 px-3 flex items-center gap-2 text-10px text-[#6f7b85]",
      );
      setProp(_el$15, "class", "w-1.5 h-1.5 rounded-full bg-[#4eb47c]");
      setProp(
        _el$17,
        "class",
        "flex-1 min-w-0 min-h-0 overflow-hidden bg-white",
      );
      insert(_el$17, () => props.children);
      effect(
        (_p$) => {
          var _v$ = `w-full h-10 px-3 flex items-center gap-3 border-0 rounded text-left text-13px cursor-pointer ${isFeed() ? "bg-[#343c45] text-white" : "bg-transparent text-[#9da8b2]"}`,
            _v$2 = loading();
  ...
  function StoryDetail() {
    ...
    const story = createMemo(() =>
      stories().find((item2) => item2.id === Number(params.id)),
    );
    return (() => {
      var _el$ = createElement("section"),
        _el$2 = createElement("div"),
        _el$3 = createElement("button"),
        _el$4 = createTextNode(`Stories`),
        _el$5 = createElement("span");
      insertNode(_el$, _el$2);
      setProp(
        _el$,
        "class",
        "h-full min-h-0 flex flex-col bg-white overflow-hidden",
      );
      insertNode(_el$2, _el$3);
      ...
      setProp(
        _el$2,
        "class",
        "h-13 flex-none px-4 flex items-center border-b border-[#dfe3e6] bg-[#f8f9fa]",
      );
      insertNode(_el$3, _el$4);
      setProp(
        _el$3,
        "class",
        "h-8 px-2.5 flex items-center gap-2 border border-[#ccd2d7] rounded bg-white text-[#56616b] text-xs cursor-pointer",
      );
      setProp(_el$3, "type", "button");
          ...
          children: (current) =>
            (() => {
              var _el$7 = createElement("article"),
                _el$8 = createElement("p"),
                _el$9 = createElement("h1"),
                _el$0 = createElement("div"),
                _el$1 = createElement("span"),
                _el$10 = createElement("strong"),
                _el$11 = createTextNode(` points`),
                _el$12 = createElement("span"),
                _el$13 = createTextNode(`submitted by `),
                _el$15 = createElement("strong"),
                _el$16 = createElement("span"),
                _el$17 = createElement("div"),
                _el$20 = createElement("a"),
                _el$21 = createTextNode(` comments on Hacker News`),
                _el$22 = createElement("div"),
                _el$23 = createElement("span"),
                _el$24 = createTextNode(
              ...
              setProp(
                _el$7,
                "class",
                "flex-1 min-h-0 overflow-y-auto px-8 py-7",
              );
              setProp(
                _el$8,
                "class",
                "m-0 mb-1 text-[#d95316] text-11px font-700 uppercase",
              );
              insert(_el$8, () => storyHost(current().url));
              setProp(
                _el$9,
                "class",
                "m-0 max-w-175 text-[#20272e] text-2xl font-650 leading-tight",
              );
              ...
              setProp(
                _el$0,
                "class",
                "mt-4.5 flex lt-md:flex-col lt-md:items-start gap-4.5 text-[#7c8790] text-xs",
              );
              ...
              setProp(
                _el$17,
                "class",
                "mt-8.5 flex lt-md:flex-col lt-md:items-start gap-2.5",
              );
              insert(
                _el$17,
                createComponent(Show, {
                  ...
                  get children() {
                    var _el$18 = createElement("a"),
                      _el$19 = createTextNode(`Read original article `);
                    insertNode(_el$18, _el$19);
                    setProp(
                      _el$18,
                      "class",
                      "px-3.5 py-2.5 flex items-center gap-2 rounded bg-[#e85b1a] text-white text-xs font-600 no-underline",
                    );
                    insert(
                      _el$18,
                    ...
                    effect((_$p) =>
                      setProp(_el$18, "href", current().url, _$p),
                    );
                    return _el$18;
                  },
                }),
              ...
              setProp(
                _el$20,
                "class",
                "px-3.5 py-2.5 border border-[#ccd2d7] rounded bg-white text-[#46535e] text-xs font-600 no-underline",
              );
              ...
              setProp(
                _el$22,
                "class",
                "max-w-175 mt-10 pt-4 flex items-center gap-2 border-t border-[#e7eaec] text-[#8a949d] text-11px",
              );
              setProp(
                _el$23,
                "class",
                "w-1.75 h-1.75 rounded-full bg-[#37a66b]",
              );
              effect((_$p) =>
                setProp(
                  _el$20,
  ...
  function MissingStory() {
    return (() => {
      var _el$25 = createElement("div"),
        _el$26 = createElement("strong"),
      ...
      setProp(
        _el$25,
        "class",
        "min-h-85 p-10 flex flex-col items-center justify-center gap-2 text-[#7c8790] text-center",
      );
        ...
        createComponent(For, {
          ...
          children: (item2) =>
            (() => {
              ...
              insert(_el$3, () => String(item2).padStart(2, "0"));
  ...
  function StoryList() {
    ...
    return (() => {
      ...
      setProp(
        _el$2,
        "class",
        "h-16 flex-none px-5 flex items-center gap-4 border-b border-[#dfe3e6] bg-[#f8f9fa]",
      );
      insertNode(_el$3, _el$4);
      insertNode(_el$3, _el$6);
      ...
      setProp(
        _el$4,
        "class",
        "m-0 text-[#20272e] text-base font-650 leading-tight",
      );
      ...
      setProp(
        _el$8,
        "class",
        "w-60 ml-auto h-8 px-2.5 flex items-center gap-2 border border-[#cbd1d6] rounded bg-white text-[#78838d] focus-within:border-[#8e9aa5]",
      );
      insert(
        _el$8,
      ...
      setProp(
        _el$9,
        "class",
        "w-full min-w-0 border-0 outline-none bg-transparent text-[#26323d] text-13px",
      );
                        ...
                        children: (story, index) =>
                          (() => {
                            var _el$15 = createElement("li"),
                              ...
                              _el$18 = createElement("span"),
                              _el$19 = createElement("strong"),
                              _el$20 = createElement("span"),
                              _el$21 = createElement("span"),
                              _el$22 = createElement("span"),
                              _el$23 = createTextNode(` points`),
                              _el$24 = createElement("span"),
                              _el$25 = createTextNode(`by `),
                              _el$26 = createElement("span"),
                              _el$27 = createElement("button"),
                              _el$28 = createElement("strong"),
                            ...
                            setProp(
                              _el$15,
                              "class",
                              "h-18 px-4 grid grid-cols-[32px_minmax(0,1fr)_64px] items-center gap-3 border-b border-[#e9ecee] hover:bg-[#f7f8f9]",
                            );
                            setProp(
                              _el$16,
                              "class",
                              "text-[#a5adb4] font-mono text-xs",
                            );
                            insert(_el$16, () =>
                            ...
                            setProp(
                              _el$17,
                              "class",
                              "min-w-0 p-0 border-0 bg-transparent text-left cursor-pointer",
                            );
                            ...
                            setProp(
                              _el$18,
                              "class",
                              "min-w-0 flex items-baseline gap-2",
                            );
                            setProp(
                              _el$19,
                              "class",
                              "min-w-0 overflow-hidden text-[#20272e] text-13px font-600 leading-snug text-ellipsis whitespace-nowrap",
                            );
                            insert(_el$19, () => story.title);
                            setProp(
                              _el$20,
                              "class",
                              "lt-md:hidden flex-none text-[#8b959e] text-11px",
                            );
                            ...
                            setProp(
                              _el$21,
                              "class",
                              "mt-1.5 flex gap-3.5 text-[#7c8790] text-11px",
                            );
                            insertNode(_el$22, _el$23);
                            ...
                            setProp(
                              _el$27,
                              "class",
                              "lt-md:hidden p-0 border-0 bg-transparent text-left cursor-pointer flex flex-col items-end text-[#8a949d] text-10px",
                            );
                            setProp(_el$27, "type", "button");
                            setProp(_el$27, "onClick", () =>
                              navigate(`/story/${story.id}`),
                            );
                            setProp(
                              _el$28,
                              "class",
                              "text-[#44515c] text-15px",
                            );
      ...
      setProp(
        _el$10,
        "class",
        "h-8 flex-none px-4 flex items-center justify-between border-t border-[#dfe3e6] bg-[#f5f6f7] text-[#7f8992] text-10px",
      );
      insertNode(_el$11, _el$12);
  ...
  function LoadError() {
    return (() => {
      var _el$31 = createElement("div"),
        _el$32 = createElement("strong"),
        _el$34 = createElement("span"),
        _el$35 = createElement("button");
      ...
      setProp(
        _el$35,
        "class",
        "mt-3 px-3.5 py-2 border border-[#cbd1d6] rounded bg-white cursor-pointer",
      );
  ...
  function EmptyState() {
    return (() => {
      var _el$37 = createElement("div"),
        _el$38 = createElement("strong"),
        _el$40 = createElement("span");
