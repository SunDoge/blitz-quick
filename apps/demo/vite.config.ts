...
// JS: compiled IIFE outputted to src/gen/bundle.js
// CSS: generated by UnoCSS and outputted to src/gen/bundle.css
...
function unocssSeparated(): Plugin {
  ...
  return {
    ...
    async writeBundle() {
      ...
      const outPath = resolve(__dirname, "../../src/gen/bundle.css");
